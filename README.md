...
![Text box that says name my pet with an icon of a dog](./public/page_content.png)
# Example image
![Text box that says name my pet with an icon of a dog](./public/rave_mantis.png)
